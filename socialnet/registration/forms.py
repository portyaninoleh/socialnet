...
class RegistrationActivationForm(forms.Form):
    activation_key = forms.CharField(widget=forms.TextInput(attrs=dict(attrs_dict,
                                                                       maxlength=75)),
                                     label=_("Confirm code"))

    def __init__(self, *args, **kwargs):
        self.activation_key1 = kwargs.pop('activation_key', None)
    ...
    def clean_activation_key(self):
        ...
        if SHA1_RE.search(activation_key):
            if self.activation_key1 == activation_key:
